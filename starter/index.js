...
function avPLChange(data) {
  ...
  var changeAv = changeSum / (data.length - 1);
  return changeAv.toFixed(2);
}

var ProfLoss = [867884, 984655, 322013, -69417, 310503, 522857, 1033096, 604885, -216386, 477532, 893810, -80353, 779806, -335203,
